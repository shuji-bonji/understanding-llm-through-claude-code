...
|:--|:--|:--|
| `CLAUDE.md`（200行以内） | [Part 3: 常駐コンテキスト](../docs/ja/03-always-loaded-context/) | Priority Saturation, Prompt Sensitivity |
| `CLAUDE.local.md` | [Part 3: 常駐コンテキスト](../docs/ja/03-always-loaded-context/) | Context Rot |
| `llms.txt` + `content.md`（外部仕様委譲） | [Part 3: 常駐コンテキスト](../docs/ja/03-always-loaded-context/) | Priority Saturation |
| `.claude/rules/`（条件付き） | [Part 4: 条件付きコンテキスト](../docs/ja/04-conditional-context/) | Priority Saturation, Lost in the Middle |
| `.claude/skills/` | [Part 5: オンデマンドコンテキスト](../docs/ja/05-on-demand-context/) | Context Rot, Knowledge Boundary |
