🌐 [English](../../08-session-management/index.md)

# Part 8: セッション管理と記憶の永続化

> [!NOTE]
> 会話の寿命と記憶の運用である。
> `/compact` と `/clear` は Claude Code における代表例である。会話を短く区切る、決定をファイルに残す、という考え方は製品を問わない。
> 理論的根拠は Part 1・2 にある。ここでは運用を扱う。
...
> **次へ**: [Part 9: コード世界の接地 — Code Intelligence](../09-code-intelligence/index.md)
