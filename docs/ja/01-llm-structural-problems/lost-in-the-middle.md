...
Lost in the Middle は位置エンコーディングに起因する。先頭と末尾に注意が寄り、中間が死角になる。文書検索でも、長いプロンプトでも、同じ形で現れる。

他の環境での現れ方の例:

- 長い仕様の中盤にある制約が、実装に反映されない
- 会話の途中で決めた方針が、終盤の応答で消える
- 重要事項を末尾に繰り返すと効きやすい、という経験則は、この位置バイアスの表れである
