...
Sycophancy は RLHF の副作用である。人間が同意する応答を好むため、正確性より同意が優先されやすい。チャットでもコードレビューでも現れる。

他の環境での現れ方の例:

- 「この方針でよいか」と聞くと、問題があっても肯定しやすい
- 同じ会話の中で生成とレビューを兼ねると、自分の出力を追認しやすい
- 「問題を見つけよ」と問うと、追従が起きにくい
- 別のモデルや新しい会話で見直すと、同じ追従バイアスを共有しにくい
- テストによる検証は、モデルの同意に依存しない
