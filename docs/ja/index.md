...
features:
  ...
  - title: "Part 3–5: 設定レイヤー"
    details: CLAUDE.md（常駐）、Rules（条件付き）、Skills & Agents（オンデマンド）
    link: /ja/03-always-loaded-context/
  - title: "Part 6–7: MCP & ランタイム"
    details: ツール定義のコンテキストコストと、LLMが見ないレイヤー
