...
- [概要：8つの構造的問題の全体像](docs/ja/01-llm-structural-problems/index.md)
- [Context Rot — トークン増で品質劣化](docs/ja/01-llm-structural-problems/context-rot.md)
- [Lost in the Middle — 中間部の情報喪失](docs/ja/01-llm-structural-problems/lost-in-the-middle.md)
- [Priority Saturation — 指示過多で遵守率低下](docs/ja/01-llm-structural-problems/priority-saturation.md)
- [Hallucination — 構造的に不可避な幻覚](docs/ja/01-llm-structural-problems/hallucination.md)
- [Sycophancy — 正確性より同意を優先](docs/ja/01-llm-structural-problems/sycophancy.md)
- [Knowledge Boundary — 「知らない」と言えない](docs/ja/01-llm-structural-problems/knowledge-boundary.md)
- [Prompt Sensitivity — 表現で結果が変動](docs/ja/01-llm-structural-problems/prompt-sensitivity.md)
- [Instruction Decay — 長会話でルール忘却](docs/ja/01-llm-structural-problems/instruction-decay.md)
...
- [概要](docs/ja/03-always-loaded-context/index.md)
- [CLAUDE.md の設計原理](docs/ja/03-always-loaded-context/claude-md.md)
- [階層マージの仕組み](docs/ja/03-always-loaded-context/hierarchy.md)
- [CLAUDE.local.md の運用](docs/ja/03-always-loaded-context/local-md.md)

### Part 4: 条件付きコンテキスト — Rules

> 必要な時だけ注入する仕組み。→ Why: Priority Saturation / Lost in the Middle 対策

- [概要](docs/ja/04-conditional-context/index.md)
- [.claude/rules/ の設計原理](docs/ja/04-conditional-context/rules.md)
- [globパターン設計の実践](docs/ja/04-conditional-context/glob-patterns.md)

### Part 5: オンデマンドコンテキスト — Skills & Agents

> 呼び出された時だけ展開される。→ Why: Context Rot / Sycophancy / Knowledge Boundary 対策

- [概要](docs/ja/05-on-demand-context/index.md)
- [Skills の設計原理](docs/ja/05-on-demand-context/skills.md)
- [Agents の設計原理](docs/ja/05-on-demand-context/agents.md)
- [import vs 別プロセスの判断基準](docs/ja/05-on-demand-context/skill-vs-agent.md)

### Part 6: ツール定義としてのコンテキスト — MCP

> ツールが消費するコンテキスト。→ Why: Context Rot / Knowledge Boundary 対策

- [概要](docs/ja/06-tool-context/index.md)
- [MCPのコンテキストコスト](docs/ja/06-tool-context/mcp-context-cost.md)
- [Tool Search / Deferred Loading](docs/ja/06-tool-context/tool-search.md)

### Part 7: LLMが見ないレイヤー — Settings & Hooks

> コンテキスト外の制御。→ Why: Hallucination / Sycophancy / Instruction Decay 対策

- [概要](docs/ja/07-runtime-layer/index.md)
- [settings.json の役割](docs/ja/07-runtime-layer/settings-json.md)
- [Hooks のライフサイクル](docs/ja/07-runtime-layer/hooks.md)
- [なぜLLMに見せないのか](docs/ja/07-runtime-layer/why-not-in-context.md)

### Part 8: セッション管理と記憶の永続化

> 会話の寿命と記憶の運用。→ Why: Context Rot / Lost in the Middle / Instruction Decay 対策

- [概要](docs/ja/08-session-management/index.md)
- [/compact と /clear の使い分け](docs/ja/08-session-management/compact-and-clear.md)
- [なぜメモリが問題になるのか](docs/ja/08-session-management/memory-problem.md)
- [何を覚えるか](docs/ja/08-session-management/what-to-remember.md)
...
- [構造的問題 × Claude Code 対策マップ（詳細版）](docs/ja/appendix/problem-countermeasure-map.md)
...
- [実践例の概要と本編との対応](examples/ja/index.md)
